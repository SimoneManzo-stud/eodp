...
toa= readToa(r"C:\Users\Simone\OneDrive\Documenti\Desktop\myoutput_EODP", r"C:\Users\Simone\OneDrive\Documenti\Desktop\myoutput_EODP\l1b_toa_VNIR-0.nc")
toa_out= readToa(r'C:\Users\Simone\OneDrive\Documenti\Desktop\EODP-TS-L1B\output"', r"C:\Users\Simone\OneDrive\Documenti\Desktop\EODP-TS-L1B\output\l1b_toa_VNIR-0.nc")

# Compute relative difference, avoid division by zero using a small epsilon (1e-12)
diff_rel = np.abs((toa_out - toa) / np.maximum(np.abs(toa), 1e-12))
