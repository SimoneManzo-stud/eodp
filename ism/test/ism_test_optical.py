...
def check_toa_all(ref_dir, out_dir, prefix="ism_toa_optical_", threshold=1e-4):
    """
    Automatically check TOA reference vs output for all available .nc bands.

    Parameters
    ----------
    ref_dir : str
        Directory containing reference TOA files (.nc).
    out_dir : str
        Directory containing output TOA files (.nc).
    prefix : str
        Common prefix of TOA files (default: "ism_toa_optical_").
    threshold : float
...
check_toa_all(
    ref_dir=r"C:\Users\Simone\OneDrive\Documenti\Desktop\my_output_ism_0910",
